...
/**
 * Test for /develop/cleancardcaseitem
 */
Test('/develop/cleancardcaseitem', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test develop_cleanCardcaseItem get operation', function (t) {
            Mockgen().requests({
                path: '/develop/cleancardcaseitem',
                operation: 'get'
            }, function (err, mock) {
                var request;
                t.error(err);
