...
/**
 * Test for /develop/generatemockdata
 */
Test('/develop/generatemockdata', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test develop_generateMockData get operation', function (t) {
            Mockgen().requests({
                path: '/develop/generatemockdata',
                operation: 'get'
            }, function (err, mock) {
                var request;
                t.error(err);
