...
/**
 * Test for /develop/refreshaccesstoken
 */
Test('/develop/refreshaccesstoken', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test develop_refreshAccessToken get operation', function (t) {
            Mockgen().requests({
                path: '/develop/refreshaccesstoken',
                operation: 'get'
            }, function (err, mock) {
                var request;
                t.error(err);
