...
/**
 * Test for /develop/resetdatabase
 */
Test('/develop/resetdatabase', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test develop_resetDatabase get operation', function (t) {
            Mockgen().requests({
                path: '/develop/resetdatabase',
                operation: 'get'
            }, function (err, mock) {
                var request;
                t.error(err);
