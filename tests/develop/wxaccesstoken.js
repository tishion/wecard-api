...
/**
 * Test for /develop/wxaccesstoken
 */
Test('/develop/wxaccesstoken', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test develop_getWxAccessToken get operation', function (t) {
            Mockgen().requests({
                path: '/develop/wxaccesstoken',
                operation: 'get'
            }, function (err, mock) {
                var request;
                t.error(err);
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/develop/wxaccesstoken']['get']['responses']['200']['schema']);
