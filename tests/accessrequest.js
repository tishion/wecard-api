...
/**
 * Test for /accessrequest
 */
Test('/accessrequest', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test accessreqeust_get get operation', function (t) {
            Mockgen().requests({
                path: '/accessrequest',
                operation: 'get'
            }, function (err, mock) {
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/accessrequest']['get']['responses']['200']['schema']);
