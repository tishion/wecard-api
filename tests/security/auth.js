...
/**
 * Test for /security/auth
 */
Test('/security/auth', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test security_auth get operation', function (t) {
            Mockgen().requests({
                path: '/security/auth',
                operation: 'get'
            }, function (err, mock) {
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/security/auth']['get']['responses']['200']['schema']);
