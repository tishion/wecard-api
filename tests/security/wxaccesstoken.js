...
/**
 * Test for /security/wxaccesstoken
 */
Test('/security/wxaccesstoken', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test security_getWxAccessToken get operation', function (t) {
            Mockgen().requests({
                path: '/security/wxaccesstoken',
                operation: 'get'
            }, function (err, mock) {
                var request;
                t.error(err);
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/security/wxaccesstoken']['get']['responses']['200']['schema']);
