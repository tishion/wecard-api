...
/**
 * Test for /security/wxacodeimage
 */
Test('/security/wxacodeimage', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test security_getWxQRCodeImage get operation', function (t) {
            Mockgen().requests({
                path: '/security/wxacodeimage',
                operation: 'get'
            }, function (err, mock) {
                var request;
                t.error(err);
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/security/wxacodeimage']['get']['responses']['200']['schema']);
