...
/**
 * Test for /cardcase/{id}
 */
Test('/cardcase/{id}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test cardcase_getById get operation', function (t) {
            Mockgen().requests({
                path: '/cardcase/{id}',
                operation: 'get'
            }, function (err, mock) {
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/cardcase/{id}']['get']['responses']['200']['schema']);
